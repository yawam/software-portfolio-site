...
const stacks = [
  ...
  {
    src: "https://axl8uyhwd5.ufs.sh/f/7dF6fxvLS6wZlqaLc5Ak0Q9EUqhDuix7O25SMdpCnayNmABv",
    alt: "Express.js Logo",
  },
  {
  ...
  {
    src: "https://axl8uyhwd5.ufs.sh/f/7dF6fxvLS6wZ5RXizV16ZPxrU8Qhzq5sVkoAwO2mDCy9in1a",
    alt: "PostgreSql logo",
  },
  {
  ...
  {
    src: "https://axl8uyhwd5.ufs.sh/f/7dF6fxvLS6wZa00q31HSiQM8fmWC1Ao0eglLJH2u6DsEIBOd",
    alt: "C++ Logo",
  },
  {
    src: "https://axl8uyhwd5.ufs.sh/f/7dF6fxvLS6wZM5ODB7pgNJHuPdAw3BvEbFKkGfcqzlI5hr7T",
    alt: "C Logo",
  },
];
export default function TechStacks() {
  return (
    <div className="flex h-[500px] w-full flex-col md:w-[50%]">
      ...
      <div className="flex h-[500px] w-full flex-col justify-start rounded-2xl bg-neutral-900/50 p-2 shadow-2xl">
        <h2 className="text-center text-2xl">Top Stacks</h2>
        <div className="flex flex-wrap justify-center gap-4 py-2">
          {topStacks.map((stack, key) => (
            <div
              key={key}
        ...
        <h2 className="text-center text-2xl">Other Proficiencies</h2>
